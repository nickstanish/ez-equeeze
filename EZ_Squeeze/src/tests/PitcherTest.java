...
/**
 * JUnit 4 Test Tests usage of Pitcher class
 * 
 * @author Nick Stanish
 *
 */
public class PitcherTest {
  ...
  /**
   * test tracks many aspects of the pitcher class such as -cupsRemaining after refill, and
   * before/after serving -serving with missing ice/cups -refilling with not enough ingredients
   */
  @Test
